  ...
  Barcoder.prototype.validate = function( barcode ) {
    ...
    if ( self.format === 'autoSelect' ) {
      ...
      if ( !isValidGtin ) {
        ...
        if ( barcode.length == 8 ) {
          var b = barcode;
          // Could be a UPC-E compressed barcode
          if (b[6] == '0' || b[6] == '1' || b[6] == '2') {
            var upca = b[0] + b[1] + b[2] + b[6] + '0000' + b[3] + b[4] + b[5] + b[7];
          } else if ( b[6] == '3' ) {
            var upca = b[0] + b[1] + b[2] + b[3] + '00000' + b[4] + b[5] + b[7];
          } else if ( b[6] == '4' ) {
            var upca = b[0] + b[1] + b[2] + b[3] + b[4] + '00000' + b[5] + b[7];
          } else {
            var upca = b[0] + b[1] + b[2] + b[3] + b[4] + b[5] + '0000' + b[6] + b[7];
          }

          if ( validateGtin( '0' + upca ) ) {
            return { possibleType: 'UPC-E', isValid: true };
          }
        }
